...
public class FileDownloader {
    ...
    private  AtomicInteger receivedLength=new AtomicInteger(0);
    ...
    public void startDownload() throws IOException {
       ...
       if(fileLength<1){
        ...
        while (finishedThread.size()<threadNum&&failThreadNum.get()<1){
            ...
            logger.info("file has download "+df.format(receivedLength.get()*100.0/fileLength)+"%");
    ...
    private byte[] toByteArray(InputStream input) throws IOException {
        ...
        for(; -1 != (n = input.read(buffer)); ) {
           ...
           this.receivedLength.addAndGet(n);
...
//                connection.addRequestProperty("User-Agent", "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; .NET CLR 2.0.50727");
            ...
            receivedLength.set(receivedLength.get()-increaseVal);
...
// 5.email tips
// 6.logger print log,remove System.out.println